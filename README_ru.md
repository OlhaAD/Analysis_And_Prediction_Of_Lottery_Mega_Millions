...
6. **Оценка модели**
  - Оценка производительности модели полиномиальной регрессии с использованием метрик, таких как средняя абсолютная ошибка (MAE) и корень средней квадратичной ошибки (RMSE).
